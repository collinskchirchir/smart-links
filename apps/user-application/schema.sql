...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_link_clicks_account_id` ON `link_clicks` (`account_id`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_link_clicks_clicked_time` ON `link_clicks` (`clicked_time`);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_link_clicks_id` ON `link_clicks` (`id`);
--> statement-breakpoint
